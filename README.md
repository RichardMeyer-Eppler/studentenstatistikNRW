...
You can install the released version of studentenstatistikNRW from
[CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("studentenstatistikNRW")
```
...
devtools::install_github("RichardMeyer-Eppler/studentenstatistikNRW")
```
