#' 21311NW013 - Studierende / Studenten, Land, Nationalität, Semester
#'
...
#'
#' @format A tibble with `r get_nrow(df_21311NW013)` rows and `r get_ncol(df_21311NW013)` variables:
#' \describe{
