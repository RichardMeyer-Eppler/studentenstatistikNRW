#' 21311NW003A - Studierende / Studenten, Land, Hochschulen, Geschlecht, Hörerstatus, Semester
#'
...
#'
#' @format A tibble with `r get_nrow(df_21311NW003A)` rows and `r get_ncol(df_21311NW003A)` variables:
#' \describe{
