#' 21311NW012 - Studierende / Studenten, Land, Geschlecht, Semester
#'
...
#'
#' @format A tibble with `r get_nrow(df_21311NW012)` rows and `r get_ncol(df_21311NW012)` variables:
#' \describe{
