#' 21311NW001A - Studierende / Studenten, Land, Hochschulen, Fachsemester, Geschlecht, Hörerstatus, Angestrebte Abschlussprüfung, Semester
#'
...
#'
#' @format A tibble with `r get_nrow(df_21311NW001A)` rows and `r get_ncol(df_21311NW001A)` variables:
#' \describe{
