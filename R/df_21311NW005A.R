#' 21311NW005A - Studierende / Studenten, Land, Hochschulen, Hochschulsemester, Geschlecht, Hörerstatus, Angestrebte Abschlussprüfung, Semester
#'
...
#'
#' @format A tibble with `r get_nrow(df_21311NW005A)` rows and `r get_ncol(df_21311NW005A)` variables:
#' \describe{
