#' 21311NW010 - Studierende / Studenten, Land, Nationalität, Hörerstatus, Semester
#'
...
#'
#' @format A tibble with `r get_nrow(df_21311NW010)` rows and `r get_ncol(df_21311NW010)` variables:
#' \describe{
