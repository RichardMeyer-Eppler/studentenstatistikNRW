#' 21311NW003B - Studierende / Studenten, Land, Hochschulen, Nationalität, Hörerstatus, Semester
#'
...
#'
#' @format A tibble with `r get_nrow(df_21311NW003B)` rows and `r get_ncol(df_21311NW003B)` variables:
#' \describe{
