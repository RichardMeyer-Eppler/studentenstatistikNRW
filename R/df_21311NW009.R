#' 21311NW009 - Studierende / Studenten, Land, Nationalität, Geschlecht, Semester
#'
...
#'
#' @format A tibble with `r get_nrow(df_21311NW009)` rows and `r get_ncol(df_21311NW009)` variables:
#' \describe{
