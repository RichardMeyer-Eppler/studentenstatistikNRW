#' 21311NW007A - Studierende / Studenten, Land, Hochschulen, Studienfach, Geschlecht, Semester
#'
...
#'
#' @format A tibble with `r get_nrow(df_21311NW007A)` rows and `r get_ncol(df_21311NW007A)` variables:
#' \describe{
