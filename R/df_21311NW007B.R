#' 21311NW007B - Studierende / Studenten, Land, Hochschulen, Studienfach, Nationalität, Semester
#'
...
#'
#' @format A tibble with `r get_nrow(df_21311NW007B)` rows and `r get_ncol(df_21311NW007B)` variables:
#' \describe{
