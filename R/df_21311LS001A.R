#' 21311LS001A - Studierende / Studenten, Land, Hochschulen, Studienfach, Fachsemester, Angestrebte Abschlussprüfung, Semester
#'
...
#'
#' @format A tibble with `r get_nrow(df_21311LS001A)` rows and `r get_ncol(df_21311LS001A)` variables:
#' \describe{
