#' 21311LS002A - Studierende / Studenten, Land, Hochschulen, Studienfach, Hochschulsemester, Angestrebte Abschlussprüfung, Semester
#'
...
#'
#' @format A tibble with `r get_nrow(df_21311LS002A)` rows and `r get_ncol(df_21311LS002A)` variables:
#' \describe{
