#' 21311NW006B - Studierende / Studenten, Land, Hochschulen, Studienfach, Hochschulsemester, Nationalität, Semester
#'
...
#'
#' @format A tibble with `r get_nrow(df_21311NW006B)` rows and `r get_ncol(df_21311NW006B)` variables:
#' \describe{
