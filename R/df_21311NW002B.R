#' 21311NW002B - Studierende / Studenten, Land, Hochschulen, Fachsemester, Nationalität, Semester
#'
...
#'
#' @format A tibble with `r get_nrow(df_21311NW002B)` rows and `r get_ncol(df_21311NW002B)` variables:
#' \describe{
