#' 21311NW004A - Studierende / Studenten, Land, Studienfach, Geschlecht, Hörerstatus, Semester
#'
...
#'
#' @format A tibble with `r get_nrow(df_21311NW004A)` rows and `r get_ncol(df_21311NW004A)` variables:
#' \describe{
