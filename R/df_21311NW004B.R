#' 21311NW004B - Studierende / Studenten, Land, Studienfach, Nationalität, Hörerstatus, Semester
#'
...
#'
#' @format A tibble with `r get_nrow(df_21311NW004B)` rows and `r get_ncol(df_21311NW004B)` variables:
#' \describe{
