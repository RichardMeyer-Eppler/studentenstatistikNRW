#' 21311NW008 - Studierende / Studenten, Land, Nationalität, Geschlecht, Hörerstatus, Semester
#'
...
#'
#' @format A tibble with `r get_nrow(df_21311NW008)` rows and `r get_ncol(df_21311NW008)` variables:
#' \describe{
