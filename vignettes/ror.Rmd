...
#### Names
Because `df_ror_germany_education` contains many list columns, extracting data can be quite cumbersome. For illustrative purposes, this is one way of retrieving all content from `df_ror_germany_education[["names"]]` for each organization.
